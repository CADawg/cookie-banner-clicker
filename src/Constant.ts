...
const COMPANIES: ICompany[] = [
    ...
    {id: "giggle_analytics", name: "Giggle Analytics", cookies: [{purpose_id: "statistics", id: "ga-ui", name: "User ID", description: "A persistent ID which tracks the user across the web", https: true, duration: "1 year"}, {purpose_id: "statistics", id: "ga-ua", name: "Giggle Analytics User Agent", description: "The user agent used by Giggle Analytics", https: true, duration: "1 year"}]},
    {id: "giggle_advertising", name: "Giggle Advertising", cookies: [{purpose_id: "giggle_personalisation", id: "ga-ui", name: "User ID", description: "A persistent ID which tracks the user across the web", https: true, duration: "1 year"}, {purpose_id: "marketing", id: "ga-ua", name: "Giggle Advertising User Agent", description: "The user agent used by Giggle Advertising", https: true, duration: "1 year"}]},
...
const PURPOSES: IPurpose[] = [
    ...
    {id: "giggle_personalisation", name: ["Giggle Personalisation"], description: ["Personalisation by the Giggle Company"], required: false, alwaysShow: false},
